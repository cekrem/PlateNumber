#!/bin/bash
# This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.4.3/Targets/iOS/build.sh.
...
##else
    xcodebuild -project "PlateNumber.xcodeproj" "$@" | tee >(checkForError)
##endif
