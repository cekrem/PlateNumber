...
static void GeneratedApplication_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("10.0.1.7");
    ::STRINGS[2] = uString::Const("/Users/cekrem/Fuse/PlateNumber/PlateNumber.unoproj");
    ::STRINGS[3] = uString::Const("PlateNumber");
